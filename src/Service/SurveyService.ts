...
export class SurveyService {
    ...
    private static buildPopupContent(): string {
        ...
        return '<div style="padding:10px; max-width:500px; color:#333;">'
            ...
            + '<p style="margin-bottom:10px; font-size:11px; padding:6px; background:#fff3cd; border:1px solid #ffc107; border-radius:4px;"><b>Note:</b> Tampermonkey may ask for permission to send data. Temporary rights are enough, so choose those instead of permanent ones.</p>'
